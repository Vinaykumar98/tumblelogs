...
<body id="dating">
  <h1>Tumblelogs</h1>
  <h3>Being left always!</h3>
  <?php include 'connect.php'; ?>
  <?php include 'title_bar.php'; ?>
  <br/>
  <?php
  $conn=connect();
  $sqli="SELECT id,post,qdate,qtime,userid FROM post where domain=3  ORDER BY qtime DESC";
  ...
  $userid=$row[4];
    ?>
      <div class='box'>
      <b><?php echo $userid;  ?>
     </b> <font color='#ccc'> | Date :<?php echo $post_date; ?> | Time : <?php echo $post_time; ?><br/></br/>
